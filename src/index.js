...
class SearchBar extends React.Component{
    ...
    render(){
        return(
            <input type="text" className="searchBar" value={this.state.value} onChange={this.handleInput} placeholder="a search bar like ajax "/>
        );
    }
}
...
class PriceFilter extends React.Component{
    ...
    render(){
        return (
            <div>
                <input type="number" name="minValue" value={this.state.minValue} onChange={this.handleInputChange} placeholder="Enter min price"/>
                <input type="number" name="maxValue" value={this.state.maxValue} onChange={this.handleInputChange} placeholder="Enter max price"/>
            </div>
        );
    }
}
